...
const YouTube: React.FC = () => {
    ...
    const videoGroups = isLargeScreen ? 
        videoIds.reduce((resultArray, item, index) => { 
    ...
    return (
        <div className="flex flex-col items-center space-y-4">
            <h1 className="text-2xl font-bold">Example Videos</h1>
            <Carousel infiniteLoop useKeyboardArrows autoPlay showThumbs={false} transitionTime={2000} interval={5000}>
